...
const cities = ["Karachi", "Lahore", "Islamabad", "Rawalpindi", "Multan", "Faisalabad", "Peshawar", "Quetta", "Sialkot", "Hyderabad"];
const maritalStatuses = ["Single", "Divorced no children", "Divorced have children", "Widowed no children", "Widowed have children"];
const religions = ["Islam"];
const sects = ["Sunni – Hanafi", "Sunni – Shafi", "Sunni – Maliki", "Shia", "Other"];
const tongues = ["Urdu", "Punjabi", "Sindhi", "Pashto", "Balochi", "Saraiki", "Other"];
const educations = ["Matric", "Intermediate", "Bachelor's", "Master's", "PhD", "MBBS", "Engineering", "Other"];
const professions = ["Doctor", "Engineer", "Teacher", "Business", "Student", "Government Job", "IT Professional", "Lawyer", "Other"];
    ...
    <div className="create-profile">
      <div className="create-profile__inner">
        ...
        <p className="create-profile__subtitle">
          Fill in your details so others can find you. Fields marked with * are required.
        </p>
        ...
        <div className="create-profile__form">
          ...
          <div className="create-profile__section">
            ...
            <div className="create-profile__row">
              <div className="create-profile__field">
                ...
                <input name="full_name" type="text" placeholder="Your full name" value={form.full_name} onChange={handleChange} />
              </div>
              <div className="create-profile__field">
                <label>Age *</label>
                <input name="age" type="number" placeholder="Your age" min="18" max="80" value={form.age} onChange={handleChange} />
              </div>
            </div>
            ...
            <div className="create-profile__row">
              ...
              <div className="create-profile__field">
                <label>Height</label>
                <input name="height" type="text" placeholder='e.g. 5&apos;6"' value={form.height} onChange={handleChange} />
              </div>
            </div>
          ...
          <div className="create-profile__section">
            <h3 className="create-profile__section-title">Education & Career</h3>
          ...
          <div className="create-profile__section">
            <h3 className="create-profile__section-title">Family & Background</h3>
            ...
            <div className="create-profile__row">
              ...
              <div className="create-profile__field">
                <label>Caste</label>
                <input name="caste" type="text" placeholder="Your caste" value={form.caste} onChange={handleChange} />
              </div>
            </div>
            ...
            <div className="create-profile__row">
              <div className="create-profile__field">
                ...
                <select name="mother_tongue" value={form.mother_tongue} onChange={handleChange}>
